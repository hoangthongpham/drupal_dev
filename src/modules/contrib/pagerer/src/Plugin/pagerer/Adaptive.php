...
class Adaptive extends Standard {
  ...
  protected function buildPageList(): array {
    ...
    $pages[0]['href'] = $this->getPagererManager()->getHref(
      $this->pager,
      $this->parameters,
      0,
      [0, $last]
    ...
    $pages[$last]['href'] = $this->getPagererManager()->getHref(
      $this->pager,
      $this->parameters,
      $last,
      [0, $last]
    ...
    if ($pages) {
      ...
      for ($x = 1; $x < count($kpages) - 1; $x++) {
        ...
        if (isset($d['outer_page'])) {
          $d['href'] = $this->getPagererManager()->getHref(
            $this->pager,
            $this->parameters,
            $kpages[$x],
        ...
        $d['href'] = $this->getPagererManager()->getHref($this->pager, $this->parameters, $kpages[$x], $page_ak_curr);
      }
    }
    return $pages;
  }
